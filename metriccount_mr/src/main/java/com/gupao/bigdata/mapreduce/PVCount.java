 ...
 * 思路和WordCount一致
 * 输入数据Example
 * 127.0.0.1	http://opencart.com/index.php?route=product/product/review&product_id=41	http://opencart.com/index.php?route=product/product&path=20_27&product_id=41	uid=0100007F7588435B8A04CF4302030303	10/Jul/2018:00:10:16 +0800
 * */
public class PVCount {
    ...
    public static class PVMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            // 拿到访问的url： 例如 http://opencart.com/index.php?route=product/product/review&product_id=41
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "user action pv count");
